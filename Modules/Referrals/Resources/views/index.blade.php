...
@section('breadcrumb') 
    ...
    <li class="breadcrumb-item active" aria-current="page">{{ trans('app.referrals.referrals') }}</li>
        ...
        <div class="col-12 grid-margin stretch-card">
            ...
            <div class="card">
                ...
                <div id="table-data" class="card-body">
                    ...
                    <h4 class="card-title">{{ trans('app.listOf') }} {{ trans('app.referrals.referrals') }}</h4>
